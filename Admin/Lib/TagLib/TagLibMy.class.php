...
class TagLibMy extends TagLib{
	...
	public function _webuploadercss(){
		$str=<<<php
<link rel="stylesheet" href="__PUBLIC__/admin/webuploader/css/webuploader.css">
<script src="__PUBLIC__/admin/webuploader/examples/image-upload/jquery.js"></script>
php;
		return $str;
	}
	// webuploader的js部分
	public function _webuploaderjs(){
		$str=<<<php
<script>
    var BASE_URL = '__PUBLIC__/admin/webuploader';
</script>
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        // },
        // swf文件路径
        swf: 'Public/admin/webuploaderdist/Uploader.swf',
