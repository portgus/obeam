...
document.onkeydown=banBackSpace;
 ...
 <div class="centercontent tables">
  ...
  <div class="pageheader">
            <h1 class="pagetitle">添加轮播图片</h1>
            <span class="pagedesc">ADD Banner</span>  
        </div><!--pageheader--> 
     ...
     <div id="contentwrapper" class="contentwrapper">
 		 <div id="validation" class="subcontent" >
                ...
                <form class="stdform stdform2" method="post"  enctype="multipart/form-data" action="<?php echo U('Admin/Banner/banner_save');?>">   	
                        <p>
                        	<label>图片</label>
                              <span class="field">
