...
document.onkeydown=banBackSpace;
 ...
 <div class="centercontent tables">
  ...
  <div class="pageheader">
            <h1 class="pagetitle">添加友情链接</h1>
            <span class="pagedesc">Add FriendLink</span>  
        </div><!--pageheader--> 
        
     <div id="contentwrapper" class="contentwrapper">
 		 <div id="validation" class="subcontent" >
 		
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/FriendLink/linksave');?>">
                    	<p>
                        	<label>友链名称</label>
                            <span class="field"><input type="text" name="website_name" id="firstname2" class="longinput"  value="<?php echo ($linkArr['website_name']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>友链地址</label>
                            <span class="field"><input type="text" name="link_url" id="firstname2" class="longinput" value="<?php echo ($linkArr['link_url']); ?>" required/></span>
                        </p>
                         <input type="hidden" name="space" value="<?php echo ($_GET['id']); ?>"/>
