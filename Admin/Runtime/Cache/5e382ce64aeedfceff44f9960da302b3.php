...
document.onkeydown=banBackSpace;
 ...
 <div class="centercontent tables">
  ...
  <div class="pageheader">
            <h1 class="pagetitle">产品栏目编辑</h1>
            <span class="pagedesc">Product Category Edit</span>
     ...
     <div id="contentwrapper" class="contentwrapper">
 		 ...
 		 <div id="validation" class="subcontent" >
					...
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/Product/product_cate_add');?>">
                    	<p>
                        	<label>栏目名称</label>
                            <span class="field"><input type="text" name="cate_name" id="firstname2" class="longinput"  value="<?php echo ($cate_arr['cate_name']); ?>" required/></span>
                        </p>
                          <p>
                        	<label>文件名称</label>
                            <span class="field"><input type="text" name="url_param" id="firstname2" class="longinput" value="<?php echo ($cate_arr['url_param']); ?>" /></span>
                        </p>
                        <p>
                        	<label>标题</label>
                          ...
                          <p>
                           ...
                           <p>
                        	<label>栏目描述</label>
                            <span class="field"><input type="text" name="message" id="firstname2" class="longinput"  value="<?php echo ($cate_arr['message']); ?>" /></span>
                        </p>
                        	<p>
                        	<label>栏目顺序</label>
                            <span class="field"><input type="text" name="sort" id="firstname2" class="longinput"  value="<?php echo ($cate_arr['sort']); ?>" /></span>
                        </p>
                        <p>
                        	<label>选择分类</label>
                            <span class="field">
