...
<div class="centercontent">
	...
	<form class="stdform stdform2" method="post" action="<?php echo U('Admin/News/addnews_save');?>">
                         <p>
                        	<label>内容 <small>You can put your own description for this field here.</small></label>
                            <span class="field"><textarea style="height:400px;max-height:500px;" name="content" id="textarea1" class="longinput" disabled><?php echo ($arr['content']); ?></textarea></span>
                        </p>
