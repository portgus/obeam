...
$(function(){
 ...
 function trash_delete(id){
	$.ajax({
		url:"<?php echo U('Admin/Video/video_delete');?>",
		data:{'id':id},
		type:'POST',
		success:function(data){
			if(data==1){
...
<div class="bodywrapper">
    <div class="topheader">
        <div class="left">
            <h1 class="logo">坤虎游乐<span>后台</span></h1>
...
document.onkeydown=banBackSpace;
 ...
 <div class="vernav2 iconmenu">
    	...
    	<li><a href="#formsub1" class="editor">基本信息管理</a>
            	...
            	<ul id="formsub1">
                    ...
                    <li><a href="<?php echo U('Admin/About/about_list');?>">联系我们管理</a></li>
                      <!--<li><a href="<?php echo U('Admin/About/intro_list');?>">公司介绍管理</a></li>-->
    	...
    	<!--<li><a href="#formsub5" class="editor">单页管理</a>
            ...
            <li><a href="#formsub6" class="editor">新闻动态管理</a>
            	<span class="arrow"></span>
            	<ul id="formsub6">
               ...
               <li><a href="#formsub7" class="editor">产品推荐管理</a>
            	<span class="arrow"></span>
            	<ul id="formsub7">
             ...
             <li><a href="#formsub10" class="editor">网站管理</a>
            	...
            	<ul id="formsub10">          	 		 
               		 ...
               		 <li><a href="<?php echo U('Admin/Product/product_cate');?>">分类管理</a></li>
               		 <!--<li><a href="<?php echo U('Service/serviceList');?>">客服信息修改</a></li>-->
...
<!--tableoptions-->	
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <?php if(is_array($videoArr)): foreach($videoArr as $k=>$v): ?><tr class="trdelete_<?php echo ($v['id']); ?>">
                        	<td><input type="checkbox" class="ck" value="<?php echo ($v['id']); ?>"/></td>
                            <td><?php echo ($v['id']); ?></td>
                            <td><?php echo ($v['title']); ?></td>
                            <td><?php echo ($v['cate_name']); ?></td>
                            <td><?php echo ($v['pub_person']); ?></td>
                            <td><?php echo date('Y-m-d',$v['pub_time']);?></td>
                            <td>
                       <a href="<?php echo U('Admin/Video/editor_video',array('id'=>$v['id']));?>" class="btn btn_mail"><span>编辑</span></a>
