...
document.onkeydown=banBackSpace;
 ...
 <div class="centercontent tables">
  ...
  <div class="pageheader">
            <h1 class="pagetitle">联系我们管理</h1>
            <span class="pagedesc">Contact Manage</span>  
        </div><!--pageheader--> 
        
     <div id="contentwrapper" class="contentwrapper">
 		 <div id="validation" class="subcontent" >
 		
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/About/about_save');?>">
					   <p>
                        	<label>公司名字</label>
                            <span class="field"><input type="text" name="company_name" id="firstname2" class="longinput" value="<?php echo ($aboutArr['company_name']); ?>" required/></span>
                        </p>
                    	<p>
                        	<label>公司电话</label>
                            <span class="field"><input type="text" name="phone" id="firstname2" class="longinput"  value="<?php echo ($aboutArr['phone']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>公司地址</label>
                            <span class="field"><input type="text" name="address" id="firstname2" class="longinput" value="<?php echo ($aboutArr['address']); ?>" required/></span>
                        </p>
                         <p>
                        	<label>公司邮箱</label>
                            <span class="field"><input type="text" name="email" id="firstname2" class="longinput" value="<?php echo ($aboutArr['email']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>公司QQ</label>
                            <span class="field"><input type="text" name="qq" id="firstname2" class="longinput" value="<?php echo ($aboutArr['qq']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>公司网址</label>
                            <span class="field"><input type="text" name="web_site" id="firstname2" class="longinput" value="<?php echo ($aboutArr['web_site']); ?>" required/></span>
                        </p>
                         <p>
                        	<label>公司手机</label>
                            <span class="field"><input type="text" name="mobile" id="firstname2" class="longinput" value="<?php echo ($aboutArr['mobile']); ?>" required/></span>
                        </p>
                          <p>
                        	<label>联系人</label>
                            <span class="field"><input type="text" name="port" id="firstname2" class="longinput" value="<?php echo ($aboutArr['port']); ?>" required/></span>
                        </p>
                      <input type="hidden" name="id" value="1"/>
                        <p class="stdformbutton">
                        	<!-- <button class="submit radius2">Submit Button</button> -->
                            <input type="submit" class="reset radius2" value="修改" />
                        </p>
                    </form>
