...
<body class="loginpage">
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="logo">
            	<h1 class="logo">Portgus.<span>Admin</span></h1>
            ...
            <div class="nopassword">
				<div class="loginmsg">密码不正确.</div>
                <div class="loginf">
                    <div class="thumb"><img alt="" src="__PUBLIC__/admin/images/thumbs/avatar1.png" /></div>
            ...
            <form id="login" action="<?php echo U('Admin/Login/check');?>" method="post">
