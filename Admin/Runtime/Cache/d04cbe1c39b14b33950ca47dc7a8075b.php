...
$(function(){
	$("#delete_all").click(function(){
	   ...
	   str= str.substr(0,str.length-1);   //分隔符占3个字符，截取字符串，去掉最后的"','"，这样正好匹配SQL语句
	    ...
	    $.ajax({
	        //url:"Delete.php",
	        url:"<?php echo U('Admin/Message/delete_all');?>",
	        data:{'str':str},
	        type:"POST",
...
function trash_delete(id){
	$.ajax({
		url:"<?php echo U('Admin/Message/delete');?>",
		data:{'id':id},
		type:'POST',
		success:function(data){
			if(data==1){
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <?php if(is_array($arr)): foreach($arr as $k=>$v): ?><tr class="trdelete_<?php echo ($v['id']); ?>">
                          ...
                          <td><?php echo ($v['address']); ?></td>
                              ...
                              <td class="center"><?php echo ($v['pub_time']); ?></td>
                               <td >
                               	  <a href="<?php echo U('Admin/Message/message_show',array('id'=>$v['id']));?>" class="btn btn_mail"><span>查看</span></a>
