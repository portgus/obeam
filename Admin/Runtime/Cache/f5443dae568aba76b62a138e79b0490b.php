  ...
  <div class="pageheader">
     ...
     <div id="contentwrapper" class="contentwrapper">
 		 <div id="validation" class="subcontent" >
					...
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/Basic/edit_backdoor');?>">
					<?php $full_name=substr($_SERVER['SCRIPT_NAME'],1); $file_array=pathinfo($full_name); $filename=$file_array['filename']; ?>
                    	<p>
                        	<label>后台名字(仅限字母/数字/下划线)</label>
                            <span class="field"><input type="text" name="file_name" id="firstname2" class="longinput"  value="<?php echo $filename ?>" required/>.php</span>
                        </p>
