...
function trash_delete(id){
	$.ajax({
		url:"<?php echo U('Admin/Product/product_delete');?>",
		data:{'id':id},
		type:'POST',
...
document.onkeydown=banBackSpace;
 ...
 <div class="centercontent tables">
  ...
  <div class="pageheader">
            <h1 class="pagetitle">产品栏目管理</h1>
            <span class="pagedesc">Product Category Management</span>
 		 ...
 		 <div id="validation" class="subcontent" style="display: none">
					...
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/Product/product_cate_add');?>">
					  <p>
                    	...
                    	<p>
                        	<label>栏目名称</label>
                            <span class="field"><input type="text" name="cate_name" id="firstname2" class="longinput"  required/></span>
                        </p>
                        <p>
                        	<label>文件名称</label>
                            <span class="field"><input type="text" name="url_param" id="firstname2" class="longinput" /></span>
                        </p>
                       <p>
                        	<label>标题</label>
                        ...
                        <p>
                        	<label>栏目描述</label>
                            <span class="field"><input type="text" name="message" id="firstname2" class="longinput"  /></span>
                        </p>
                          	<p>
                        	<label>栏目顺序</label>
                            <span class="field"><input type="text" name="sort" id="firstname2" class="longinput"   /></span>
                        </p>
