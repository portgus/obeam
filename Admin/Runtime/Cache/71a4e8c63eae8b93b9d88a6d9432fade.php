    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div id="basicform" class="subcontent">
 			...
 			<div class="contenttitle2">
					...
					<form class="stdform stdform2" method="post" action="<?php echo U('Admin/News/editor_save');?>"  enctype="multipart/form-data">
                        <p>
                        	<label>网页标题</label>
                            <span class="field"><input type="text" name="web_title" id="firstname2" class="longinput" value="<?php echo ($editor_arr['web_title']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>网页关键字</label>
                            <span class="field"><input type="text" name="web_keywords" id="firstname2" class="longinput" value="<?php echo ($editor_arr['web_keywords']); ?>" required/></span>
                        </p>
                        <p>
                        	<label>网页描述</label>
                            <span class="field"><input type="text" name="web_desc" id="firstname2" class="longinput" value="<?php echo ($editor_arr['web_desc']); ?>" required/></span>
                        </p>
                    	<p>
                        	<label>文章标题</label>
                            <span class="field"><input type="text" name="title" id="firstname2" class="longinput" value="<?php echo ($editor_arr['title']); ?>" required/></span>
                        </p>
                        
                       	<p>
                        	<label>文章导读</label>
                            <span class="field"><textarea style="height:100px;max-height:100px;" name="intro"  class="longinput"><?php echo ($editor_arr['intro']); ?></textarea></span>
                        </p>
                        
                       <!--    <p>
                        	<label>缩略图</label>
                            <span class="field"><img src="/<?php echo ($editor_arr['imgurl']); ?>" alt=""/></span>
                        </p>
                          ...
                          <p>
                            ...
                            <select name="cateid" id="selection2">
                            	<?php if(is_array($catearr)): foreach($catearr as $k=>$v): ?><option value="<?php echo ($v['id']); ?>"><?php echo ($v['name']); ?></option><?php endforeach; endif; ?>
                            </select>
                            </span>
                        </p>
			            ...
			            <?php $true=$editor_arr['ishot']?"checked":""; $false=$editor_arr['ishot']?'':'checked'; ?>
							<p>
                            <label>是否推荐</label>
                            <span class="field">
                            	<input type="radio" name="ishot"  value=1  <?php echo ($true); ?>> 是 &nbsp; &nbsp;
                            	<input type="radio" name="ishot"  value=0  <?php echo ($false); ?>> 否 &nbsp; &nbsp;                               
                            </span>
                        </p>
                        <input type="hidden" name="id" value="<?php echo ($editor_arr['id']); ?>"/>                                      
...
<script type="text/javascript">
    ...
    editor.config.uploadImgUrl = "<?php echo U('Admin/News/uploadImg');?>";
    editor.create();
    
  
</script>
<script>
cateid=<?php echo ($editor_arr['cateid']); ?>;
$('#selection2').val(cateid);
</script>
</html>