		...
		<form method="get" action="">
			...
			<select class="radius3" name="cateid">
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <?php if(is_array($pro_arr)): foreach($pro_arr as $k=>$v): ?><tr class="trdelete_<?php echo ($v['id']); ?>">
                            ...
                            <td>
                       <a href="<?php echo U('Admin/Product/editor_product',array('id'=>$v['id']));?>" class="btn btn_mail"><span>编辑</span></a>
